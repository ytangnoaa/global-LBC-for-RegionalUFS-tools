...
a=xr.open_dataset('INPUT-C3359-2019'+mm+'/am4_bndy.c3359.2019'+mm+'.v1.nc')
c=xr.open_dataset('/scratch2/NCEPDEV/naqfc/RRFS_CMAQ_NA13km/LBCS/RRFS_CONUS3km_AM4_v1/am4_bndy.c3359.2019'+mm+'.v1.nc')
# North LBC 
if iflag[0]:
...
#  plt.xlim(c.lon.max(),0)
  ...
  plt.xlabel('C3359 Model North Boundary Periphery (grid)',fontsize=18)
  plt.ylabel('Altitude (m)',fontsize=18)
  plt.title('AM4 O$_3$ north Lateral Boundary Condition in '+mchar,fontsize=20)
  plt.tight_layout()
  plt.savefig('figures/c3359-2019'+mm+'-am4lbc-v1-o3-north.png',dpi=300)
  plt.clf()
# West LBC
if iflag[1]:
...
#  plt.xlim(c.lat.max(),0)
  ...
  plt.xticks(fontsize=16)
  plt.yticks(fontsize=16) 
  plt.xlabel('C3359 Model West Boundary Periphery (grid)',fontsize=18)
  plt.ylabel('Altitude (m)',fontsize=18)
  plt.title('AM4 O$_3$ West Lateral Boundary Condition in '+mchar,fontsize=20)
  plt.tight_layout()
  plt.savefig('figures/c3359-2019'+mm+'-am4lbc-v1-o3-west.png',dpi=300)
  plt.clf()

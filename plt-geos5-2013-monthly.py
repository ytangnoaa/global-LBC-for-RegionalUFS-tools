...
for n in range(12):
  ...
  c=xr.open_dataset('/scratch2/NCEPDEV/naqfc/Youhua.Tang/geos5-nc/data/CGG.tavg24_3d_dac_Nv.monthly.2013'+month+'.nc4')
  ax=plt.axes(projection=ccrs.PlateCarree())
  cs3=plt.pcolormesh(c.lon,c.lat,c.O3[0,-1,:,:]*1e9,
    cmap='jet',norm=colors.BoundaryNorm(boundaries=myvalue,ncolors=256))
  plt.axis([-180,-40,10,80])
  plt.title('GEOS Surface O3 (ppbv) In 2013'+month)
  ...
  plt.tight_layout()
  plt.savefig('figures/geos_2013'+month+'_surface_o3.png',dpi=300)
  plt.clf()

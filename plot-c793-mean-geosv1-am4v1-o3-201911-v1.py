...
c=xr.open_dataset('/scratch2/NCEPDEV/naqfc/RRFS_CMAQ_NA13km/LBCS/MEAN-NA13km-GEOS5V1-AM4V1/mean-geos5v1-AM4v1.'+mm+'.nc')
# North LBC 
if iflag[0]:
...
#  plt.xlim(c.lon.max(),0)
  ...
  plt.title('Mean O$_3$ north Lateral Boundary Condition in '+mchar,fontsize=20)
  plt.tight_layout()
  plt.savefig('figures/c793-2013'+mm+'-mean-geosv1-am4v1-o3-north.png',dpi=300)
  plt.clf()
# West LBC
if iflag[1]:
...
#  plt.xlim(c.lat.max(),0)
  ...
  plt.ylabel('Altitude (m)',fontsize=18)
  plt.title('Mean O$_3$ West Lateral Boundary Condition in '+mchar,fontsize=20)
  plt.tight_layout()
  plt.savefig('figures/c793-2013'+mm+'-mean-geosv1-am4v1-o3-west.png',dpi=300)
  plt.clf()

...
! --- left and right
	...
	do i=1,nhalo
	 ...
	 enddo
       ...
       enddo
      enddo
      print*,'start read hgt from NEMSIO'
...
!         if(abs(airgocart(i,j,k)).le.1e-30) then
!          print*,'air density too low ',i,j,k,airgocart(i,j,k),pgocart(i,j,k),tv
!          stop
!         endif
	 enddo
	enddo  
       enddo
       print*,'end of reading z,p,t from NEMSIO'
	...
	do i=1,nhalo
	 do j=1,jmax
	  ...
	  do kp=1,kgocart+1
       ...
       enddo
      enddo
    print*,'begin species interpolation'   

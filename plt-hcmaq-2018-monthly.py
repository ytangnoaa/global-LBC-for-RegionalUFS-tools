...
d=xr.open_dataset('/scratch2/NCEPDEV/naqfc/Youhua.Tang/HEMIS-CMAQ-2018/GRIDCRO2D.108NHEMI2.44L.160115.nc4')
plt.figure(figsize=(12,7))
for n in range(12):
  month=str(n+1).zfill(2)
  c=xr.open_dataset('/scratch2/NCEPDEV/naqfc/Youhua.Tang/HEMIS-CMAQ-2018/CCTM_CONC_v532_intel18.0_CMAQv53_TS_108NHEMI_2018'
    +month+'_monthlyav.nc')
  ax=plt.axes(projection=ccrs.PlateCarree())
  cs3=plt.scatter(d.LON[0,0,:,:],d.LAT[0,0,:,:],s=14,c=c.O3[0,0,:,:]*1000,marker='s',edgecolors=None,
    cmap='jet',norm=colors.BoundaryNorm(boundaries=myvalue,ncolors=256))
  plt.axis([-180,-40,10,80])
  plt.title('HEMISPHERIC CMAQ Surface O3 (ppbv) In 2018'+month)
  ...
  plt.tight_layout()
  plt.savefig('figures/hcmaq_2018'+month+'_surface_o3.png',dpi=300)
  plt.clf()

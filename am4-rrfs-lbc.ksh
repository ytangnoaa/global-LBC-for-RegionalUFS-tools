...
cp -p INPUT-C793-2013$amon/geos5_bndy.c793.2013$mon.nc $TDIR/am4_bndy.c793.$year$amon.v1.nc
...
&control
 ...
 lbcfile='$TDIR/am4_bndy.c793.$year$amon.v1.nc'
...
if [ $(stat -Lc %s $TDIR/am4_bndy.c793.$year$amon.v1.nc) -gt 180000000 ]; then
...
i_s_bottom,j_s_bottom,i_s_top,j_s_top,i_s_right,j_s_right,i_s_left,j_s_left,u_s_bottom,u_s_top,u_s_right,u_s_left,v_s_bottom,v_s_top,v_s_right,v_s_left\
 $TDIR/am4_bndy.c793.$year$amon.v1.nc /scratch2/NCEPDEV/naqfc/RRFS_CMAQ_NA13km/LBCS/RRFS_NA13km_AM4_v1/am4_bndy.c793.$year$amon.v1.nc
